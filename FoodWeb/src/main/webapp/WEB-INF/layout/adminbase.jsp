            ...
            <div class="col-md-2">
                <div class="admincol2">
                    ...
                    <div class="trinhdieukhien">
                        <div class="homethongke"><a href="<c:url value="/admin/home" />"><i class="fas fa-chart-line"></i>Thống kê</a></div>
                    </div>
                    <br/>
                    <div>
                            ...
                            <div id="cuahanglist" style="display: none">
                                <c:if test="${listcuahang.size() > 0}">
                                    <c:forEach items="${listcuahang}" var="listcuahang">
                                        ...
                                        <div><a href="${cuahang}">${listcuahang.tencuahang}<c:if test="${listcuahang.active == true}">

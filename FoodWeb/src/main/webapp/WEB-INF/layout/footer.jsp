<%-- 
    Document   : footer
    Created on : Jul 22, 2022, 3:09:24 PM
    Author     : ACER
--%>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
                <h5 class="lh-lg fw-bold text-500">THEO DÕI CHÚNG TÔI</h5>
                ...
                <h3 class="text-500 my-4">Nhận ưu đãi độc quyền <br />và giảm giá trong hộp thư của bạn</h3>

...
function getCuahangClick(endpoint) {
    fetch(endpoint).then(function (res) {
        return res.json();
    }).then(function (data) {
        let  cb = document.getElementById("cuahanghot");
        if (v !== null) {
            let h=""
            for (var i = 0; i < data.length; i++) {
                {
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 h-100 mb-5">
                        <div class="card card-span h-100 text-white rounded-3"><img class="img-fluid rounded-3 h-100" src="${data[i].logo}" alt="..." />
                            ...
                            <div class="card-body ps-0">
                                <div class="d-flex align-items-center mb-3"><img class="img-fluid" src="${data[i].logo}"/>" alt="" />
                                    <div class="flex-1 ms-3">
                                        <h5 class="mb-0 fw-bold text-1000">${data[i].tencuahang}</h5><span class="text-primary fs--1 me-1"><i class="fas fa-star"></i></span><span class="mb-0 text-primary">46</span>
                                    </div>
